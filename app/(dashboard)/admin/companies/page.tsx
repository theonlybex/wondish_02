    ...
    <>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="ov mb-8" style={{ animationDelay: "0ms" }}>
          ...
          <h1 className="text-3xl font-bold text-[#1E1A1A]">Companies</h1>
        ...
        >
          <p className="text-[9px] tracking-[0.22em] uppercase font-bold mb-4" style={{ color: "#ABA6A6" }}>
            Add Company
          </p>
          <form onSubmit={handleCreate} className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl border border-[#EAE4CA] bg-white text-sm text-[#1E1A1A] outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
              required
            />
        ...
        >
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-[#1E1A1A] font-semibold mb-1">No companies yet</p>
              <p className="text-sm" style={{ color: "#ABA6A6" }}>Add one above to get started.</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    {editId === company.id ? (
                      <input
                        ...
                        className="flex-1 px-3 py-1.5 rounded-lg border border-primary text-sm text-[#1E1A1A] outline-none focus:ring-2 focus:ring-primary/20"
                        autoFocus
                      />
                    ) : (
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-[#1E1A1A]">{company.name as string}</p>
                        <p className="text-[10px] mt-0.5" style={{ color: "#ABA6A6" }}>
