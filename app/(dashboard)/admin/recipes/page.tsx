    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="ov flex items-start justify-between mb-8" style={{ animationDelay: "0ms" }}>
        <div>
          ...
          <h1 className="text-3xl font-bold text-[#1E1A1A]">Recipes</h1>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-colors mt-8"
