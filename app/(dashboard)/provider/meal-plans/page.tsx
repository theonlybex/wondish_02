  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-[#848181] text-sm mt-1">
      ...
      {Object.entries(byPatient).length === 0 ? (
        ...
        <div className="space-y-6">
          {Object.entries(byPatient).map(([id, data]) => (
            <div key={id} className="bg-white border border-[#EAE4CA] rounded-2xl p-6">
              <p className="font-semibold text-navy mb-1">{data.name}</p>
              <p className="text-[#848181] text-xs mb-4">{data.email}</p>
