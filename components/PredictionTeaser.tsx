      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-white leading-[1.1] mb-6">
            See exactly how long it takes to reach your goal
          </h2>
          <p className="text-white/40 text-lg leading-relaxed mb-8 max-w-md">
            Enter your current weight, goal weight, and weekly target. Wondish tells you the exact number of days — and builds your meal plan to get there.
          </p>
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-sm">
            ...
            <div className="relative bg-white/[0.04] border border-white/10 rounded-3xl p-8 text-center backdrop-blur-sm">
              ...
              <p className="text-2xl font-bold text-white/50 mb-6">days</p>

              <p className="text-white/30 text-sm mb-8">
                to reach your goal weight — based on your profile
              </p>

              {/* Mini stats */}
              <div className="grid grid-cols-3 gap-3 mb-6">
                {[
                  { label: "Current", value: "85 kg" },
                  { label: "Goal", value: "72 kg" },
                  { label: "Weekly", value: "−0.5 kg" },
                ].map(({ label, value }) => (
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-white/30 text-xs">Sample prediction · Sign up to see yours</span>
              </div>
            </div>
          </div>
        </div>
